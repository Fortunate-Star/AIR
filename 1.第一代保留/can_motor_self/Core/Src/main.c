...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
	...
	HAL_UARTEx_ReceiveToIdle_DMA(&huart2,re_data,5);
...
//			CAN_cmd_chassis(chassis_move.motor_chassis[0].give_current,0,0,0);
		CAN_cmd_chassis(chassis_move.motor_6020.give_current,0,0,0);
		HAL_Delay(1);
