...
#define G3508_SPEED_PID_KP 16000.0f				
#define G3508_SPEED_PID_KI 0
#define G3508_SPEED_PID_KD 0.0f
#define G3508_SPEED_PID_MAX_OUT 16000.0f
#define G3508_SPEED_PID_MAX_IOUT 2000.0f

#define G3508_POSITION_PID_KP 0.0004f 
#define G3508_POSITION_PID_KI 0
#define G3508_POSITION_PID_KD 0.03f
#define G3508_POSITION_PID_MAX_OUT 0.8f
...
#define G2006_SPEED_PID_MAX_OUT 16000.0f
...
#define G6020_SPEED_PID_KP 18000.0f       
...
#define G6020_POSITION_PID_KP 0.002f
...
//	const fp32 *chassis_INT_gyro_point;
  ...
  fp32 chassis_roll;  //陀螺仪的roll角度
	...
	fp32 chassis_yaw_gyro;
	fp32 chassis_yaw_gyro_set;
	fp32 chassis_pitch_relative_angle;
