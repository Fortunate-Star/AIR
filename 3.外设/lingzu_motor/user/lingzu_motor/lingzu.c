...
/**
  ...
  * @retval         none
  */
void set_zeropos_cybergear(LINGZU_Motor *Motor)
{
	uint8_t tx_data[8]={0};
	tx_data[0] = 1;
...
/**
  ...
  * @retval         none
  */
void motor_controlmode(LINGZU_Motor *Motor,float torque, float MechPosition, float speed, float kp, float kd)
{   
...
/**
  ...
  * @retval         none
  */
void set_current_cybergear(LINGZU_Motor *Motor,float Current)
{
...
/**
  ...
  * @retval         None
  */
void stop_cybergear(LINGZU_Motor *Motor,uint8_t clear_error)
{
	uint8_t tx_data[8]={0};
...
/**
  ...
  * @retval         none
  */
void set_CANID_cybergear(LINGZU_Motor *Motor,uint8_t CAN_ID)
{
	uint8_t tx_data[8]={0};
...
/**
  ...
  * @retval         none
  */
void set_mode_cybergear(LINGZU_Motor *Motor,uint8_t Mode)
{	
...
/**
  ...
  * @retval         none
  */
void start_cybergear(LINGZU_Motor *Motor)
{
    uint8_t tx_data[8] = {0}; 
...
/**
  ...
  * @retval         none
  */
static void Set_Motor_Parameter(LINGZU_Motor *Motor,uint16_t Index,float Value,char Value_type){
	uint8_t tx_data[8];
...
/**
  ...
  * @retval         None
  */
static void Motor_Data_Handler(LINGZU_Motor *Motor,uint8_t DataFrame[8],uint32_t IDFrame)
{	
