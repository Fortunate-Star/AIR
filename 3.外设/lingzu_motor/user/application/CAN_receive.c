...
//#define get_lingzu_motor_measure(ptr, data) 
//		{
//			(ptr)->angle = (ptr)->((data[1] << 8) | data[0]);  // 当前角度
//			(ptr)->speed = (uint16_t)((data[3] << 8) | data[2]); // 当前角速度
//			(ptr)->torque = (uint16_t)((data[5] << 8) | data[4]);  // 当前力矩
//			(ptr)->temp = data[6];  // 当前温度
//		}
...
//				case CAN_6020_M1_ID:
//				{
//					get_6020_motor_measure(&motor_6020[0],rx_data);
//					break;
//				}
//				case CAN_6020_M2_ID:
//				{
//					get_6020_motor_measure(&motor_6020[1],rx_data);
//					break;
//				}
...
//				case CAN_6020_M1_ID:
//				{
//					get_6020_motor_measure(&motor_6020[0],rx2_data);
//					break;
//				}
//				case CAN_6020_M2_ID:
//				{
//					get_6020_motor_measure(&motor_6020[1],rx2_data);
//					break;
//				}
