...
//	chassis_move_control_loop->motor_chassis[i].motor_angle_set);
	...
	chassis_move_control_loop->motor_chassis[i].speed, speed_turn[i]);
	}
	...
	chassis_move_control_loop->motor_chassis[i].motor_angle_set=1000;
	angle_out_3508=PID_Calc_Ecd(&chassis_move_control_loop->motor_chassis[i].motor_angle_pid,
	chassis_move_control_loop->motor_chassis[i].motor_angle,
	chassis_move_control_loop->motor_chassis[i].motor_angle_set,8192);
	...
	//转盘控制
		...
		chassis_move_control_loop->motor_6020[0].give_current =
		PID_Calc(&chassis_move_control_loop->motor_6020[0].motor_speed_pid,
		chassis_move_control_loop->motor_6020[0].speed, speed_6020);
		
		chassis_move_control_loop->motor_6020[1].give_current = -(
		PID_Calc(&chassis_move_control_loop->motor_6020[1].motor_speed_pid,
		chassis_move_control_loop->motor_6020[1].speed, speed_6020));
